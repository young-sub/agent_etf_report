...
Issue #18 adds offline holdings-history reconciliation for this layout. After
the report/readiness cutover, provider-scoped caches are the operating
substrate. The older canonical mixed history remains compatibility/archive
evidence and a reconciliation source; provider histories are validated against it
or created only when missing. Reconciliation summaries must preserve canonical
totals, report provider row/ETF/snapshot/date coverage, flag
